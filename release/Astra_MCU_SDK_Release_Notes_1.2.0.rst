...
============
   ...
   Astra MCU SDK 1.2.0 Release is a software development kit supporting
...
-  Applications showcasing camera-based sensing and wakeup, person
   detection/classification/pose detection, segmentation, hand gesture
   detection, JPEG pre-roll with frame transfer over USB CDC to host PC
   or SPI to another receiver (SPI capable device) and audio.
...
====================== ==================================
   ...
   Release folder      
   File name              ASTRA_MCU_SDK1.2.0.tgz
   SYNA Toolkit           SynaToolkit v2.6
   APBL                   APBL v012F
   SPK                    SPK RC3.0
====================== ==================================
