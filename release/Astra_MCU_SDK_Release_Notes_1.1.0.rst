...
============
   ...
   Astra MCU SDK 1.1.0 Release is a software development kit supporting
...
-  Astra MCU SDK VSCode Extension now supports Docker-based build and
...
+============+==============================+============+==========+
| MCU SDKI-655 |    SPI Transfer gets         | SPI        | Major    |
|            |    corrupted beyond 1M       |            |          |
|            |    speed.                    |            |          |
+------------+------------------------------+------------+----------+
|            |                              |            |          |
