...
============
   ...
   The Astra MCU SDK 1.6.0 is a software development kit that supports
...
Vision: Pre-roll                         √                    X
Vision: Face ID + Hand Gesture Detection √                    X
Hand Gesture + Air Mouse                 √                    X
======================================== ==================== ====
...
|             | non-loopback mode         |              |          |
+-------------+---------------------------+--------------+----------+
| SRSDKI-1526 | Pin connection details    | I2S/TDM      | Medium   |
|             | are missing in the readme |              |          |
|             | file for I2S/TDM sample   |              |          |
|             | app                       |              |          |
+-------------+---------------------------+--------------+----------+
| SRSDKI-1529 | Timeout is observed       | SPI          | Medium   |
|             | during SPI data transfers |              |          |
|             | in non-loopback mode      |              |          |
+-------------+---------------------------+--------------+----------+
| SRSDKI-1530 | In SPI Pre-roll case,     | SPI Pre-roll | Medium   |
|             | initial transfer passes,  |              |          |
|             | but subsequent transfers  |              |          |
|             | fail                      |              |          |
+-------------+---------------------------+--------------+----------+
| SRSDKI-1335 | Current reading in Gear 0 | Jpeg preroll | Medium   |
...
================ ======== ==============================
   ...
   August 2026      0.7      Astra MCU SDK Release 1.6.0
================ ======== ==============================
