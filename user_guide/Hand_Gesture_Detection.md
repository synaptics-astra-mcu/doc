...
1. **Select Default Configuration and build sdk + example**
   ...
   ```
   This configuration uses HD resolution by default.
...
### Setup and Flashing
   ...
   3. **Flash the Application**
         ...
         * Before flashing the models/binaries, ensure that a full flash erase is performed.
      ...
      - Location: `examples/vision_examples/uc_hand_gesture_detection/models/`
...
2. **Before running the application, make sure to connect a USB cable to the Application SR110 USB port on the Astra Machina Micro board and then press the reset button**    
   ...
   ![Serial Connection](../_static/Assets/Images/user_guide/hand_gesture_detection/image_1.png)

3. **The example logs will then appear in the logger window.**  

   ![Usecase Logs](../_static/Assets/Images/user_guide/hand_gesture_detection/image_2.png)

4. **Next, navigate to Tools → Video Streamer in SynaToolkit to run the application.**  

   ![Tools - Video Streamer](../_static/Assets/Images/user_guide/hand_gesture_detection/image_3.png)
...
5. **Video Streamer**  
   ...
   ![Video Streamer Settings](../_static/Assets/Images/user_guide/hand_gesture_detection/image_4.png)

   - Click **Create Usecase**  
   - Connect the image source  
   - Click **Start Usecase** to begin real-time hand gesture detection 

   ![Usecase Running](../_static/Assets/Images/user_guide/hand_gesture_detection/image_5.png)

6. **After starting the use case, Hand gesture detection will begin streaming video as shown below.**
   ![Usecase Running](../_static/Assets/Images/user_guide/hand_gesture_detection/image_6.png)
