...
### 1. Using Astra MCU SDK VS Code extension
   ...
   - Select **person_segmentation** in the **Application** dropdown. This will apply the defconfig.
   ...
   ![Build Configurations](../_static/Assets/Images/user_guide/person_segmentation/image_1.png)
...
2. **Generate Binary Files**
   - FW Binary generation
      ...
      ![Binary Conversion](../_static/Assets/Images/user_guide/person_segmentation/image_2.png)
...
3. **Flash the Application**
   ...
   * Choose the respective image bins and click **Run**.
   ...
   ![Image Flashing](../_static/Assets/Images/user_guide/person_segmentation/image_3.png)
   ...
   **For VGA resolution:**
   ...
   - **Steps:**
   1. Flash the pre-generated model binary: `person_segmentation_flash(448x640).bin`.
      Due to memory constraints, the model weights need to be stored in Flash.
      Browse and select this binary from the location: `examples/vision_examples/uc_person_segmentation/models/`
      ...
      ![Model Flashing](../_static/Assets/Images/user_guide/person_segmentation/image_4.png)
...
1. After successfully flashing the usecase and model bianries, click on **Video Streamer** option in the side panel. This will open the Video Streamer webview.

   ![Video Streamer](../_static/Assets/Images/user_guide/person_segmentation/image_5.png)
...
3. Select **PERSON_SEGMENTATION** from the **UC ID** dropdown. Select **RGB Demosaic**: BayerRGGB

   ![Video Streamer Options](../_static/Assets/Images/user_guide/person_segmentation/image_6.png)
...
4. Click **Create Use Case** button. Then click the **Start Use Case** button. A python window will be opened and video stream will be displayed as shown below. Logs can be viewed through the Serial Monitor
   ...
   ![Video Stream Window](../_static/Assets/Images/user_guide/person_segmentation/image_7.png)
