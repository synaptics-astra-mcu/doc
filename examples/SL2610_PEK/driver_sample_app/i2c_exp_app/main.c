...
/**
 * \brief Main function - entry point for I2C Expander GPIO toggle application
 *
 * Initializes the system and services, starts the I2C expander GPIO toggle task,
 * and starts the FreeRTOS scheduler.
 *
 * \return Should never return (scheduler runs indefinitely)
 */
int main(void)
{
    ...
    /* Start the I2C expander GPIO toggle task */
    i2c_exp_app_task();
