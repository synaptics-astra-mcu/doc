...
/* Stack and Task Control Block for SPWM sample application */
static StackType_t spwm_sample_app_stack[DEFAULT_STACK_DEPTH];
static StaticTask_t spwm_sample_app_task_buffer;
...
int main(void)
{
    ...
    /* Run SPWM sample application. */
    xTaskCreateStatic((void*)spwm_sample_app_main,       /* Task function */
                        "SPWM_SAMPLE_APP",               /* Task name (for debugging) */
                        DEFAULT_STACK_DEPTH,             /* Stack depth (in words) */
                        NULL,                            /* Task parameter */
                        UC_MANAGER_TASK_PRIORITY,        /* Task priority */
                        spwm_sample_app_stack,           /* Stack buffer */
                        &spwm_sample_app_task_buffer     /* Task control block (TCB) */
                    );
