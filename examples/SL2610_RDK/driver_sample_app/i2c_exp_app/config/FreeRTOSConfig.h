 ...
 * --------------------------------------------------------------------------*/
 ...
 #if CONFIG_OPTION_LTO_HELPER
   #define configLTO_HELPER                                  1
...
//  #include "RTE_Components.h"
 ...
 #if CONFIG_MODULE_SEGGER_SYSVIEW_ENABLED
 ...
 //  <i> Default: 16
 #define configMAX_SYSCALL_INTERRUPT_PRIORITY    160  /* equivalent to priority 4. */
 ...
 //  <o>Tick type width in bits
 //  <i> Set the bit width of TickType_t data type.
 //    <16=>16-bit <32=>32-bit <64=>64-bit
 //  <i> Default: 32-bit for most applications
 ...
 /* FreeRTOS 11.1.0 new configuration options */
 /* Note: configUSE_16_BIT_TICKS is replaced by configTICK_TYPE_WIDTH_IN_BITS in 11.1.0 */
 ...
 #if 1
 #include <stdio.h>
 #define configASSERT(x)  if( ( x ) == 0 ) { printf(" Assert called: File=%s:Line=%d:Function=%s\n", __FILE__, __LINE__ , __FUNCTION__); }
 #else
 ...
 /* Addition by Emza */
 #define TASK_INIT_MAX_FAIL_COUNTER				        (5)
