# Setup Guide for Development Environment on MAC x86_64 for LLVM-CLANG

Content:

- [Setup Guide for Development Environment on Mac x86_64 for LLVM-CLANG](#setup-guide-for-development-environment-on-mac-x86_64-for-llvm-clang)
  ...
  - [Install the ARM GNU GCC Compiler](#install-the-arm-gnu-toolchain)
...
Download the llvm-clang version 21.1.8
```
