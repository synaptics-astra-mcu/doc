...
- `sr110_rdk_cm55_usb_cdc_echo_sample_app_defconfig`
...
2. Select the **usb_cdc_echo_sample_app** project configuration in the **Project Configuration** dropdown.
...
2. Generate the flash image:
   ...
   python srsdk_image_generator.py \
     ...
     -m55_image "<sdk-root>/examples/usb_examples/usb_cdc_echo_sample_app/out/sr110_cm55_fw/release/sr110_cm55_fw.elf" \
