...
Before building, choose the testcase defconfig that matches the validation flow you want to run.
...
2. Select **i3c_sample_app** in the **Application** dropdown.
...
6. Build with **Build (SDK + App)** for the first build, or **Build App** for rebuilds.
