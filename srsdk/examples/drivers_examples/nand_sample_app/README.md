# Nand Sample Application

## Description

This NAND flash sample application demonstrates initialization, JEDEC ID detection, erase, read, and write operations on an external SPI-NAND flash device. It measures read/write throughput across different I/O widths and modes (SDR), while validating data integrity and logging performance results under FreeRTOS.
...
### 1. Using Astra MCU SDK VS Code extension
   ...
   - Select **cm52_nand_sample_app_rdk** in the **Application** dropdown. This will apply the defconfig.
   ...
   ![Build Configurations](assets/vs_nand_sl2610_rdk.png)
