...
- Common application sources such as `main.c`, `uc_person_classification.c`, and `uc_person_classification.h` stay in the app root.
...
- `sr110_rdk_cm55_person_classification_vga_img_proc_autorun_defconfig`
- `sr110_rdk_cm55_person_classification_vga_img_proc_defconfig`
- `sr110_rdk_cm55_person_classification_wqvga_img_proc_autorun_defconfig`
- `sr110_rdk_cm55_person_classification_wqvga_img_proc_defconfig`
- `sr110_rdk_cm55_person_classification_wqvga_lpsense_autorun_defconfig`
- `sr110_rdk_cm55_person_classification_wqvga_lpsense_defconfig`
...
1. Build from the application directory itself:
   ```bash
   cd <sdk-root>/examples/vision_examples/uc_person_classification
...
2. Generate the flash image:
   ...
   python srsdk_image_generator.py \
     ...
     -m55_image "<sdk-root>/examples/vision_examples/uc_person_classification/out/sr110_cm55_fw/release/sr110_cm55_fw.elf" \
