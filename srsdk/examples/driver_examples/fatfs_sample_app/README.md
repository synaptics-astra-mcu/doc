...
2. Select the **fatfs_sample_app** project configuration in the **Project Configuration** dropdown.
...
2. Generate the flash image:
   ...
   python srsdk_image_generator.py \
     ...
     -m55_image "<sdk-root>/examples/driver_examples/fatfs_sample_app/out/sr110_cm55_fw/release/sr110_cm55_fw.elf" \
