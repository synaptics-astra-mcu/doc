...
- `sr110_rdk_cm55_inference_multi_model_sample_app_defconfig`
...
2. Generate the flash image:
   ...
   python srsdk_image_generator.py \
     ...
     -m55_image "<sdk-root>/examples/inference_examples/inference_multi_model_sample_app/out/sr110_cm55_fw/release/sr110_cm55_fw.elf" \
