...
3. In **Image Flashing** (SWD/JTAG), flash the converted model binary first at offset `0x629000`.
   - Example model flash binary path: `examples/out/bin_files/Output/B0_Flash/Components/3_ssd_slim_136x240x1_yaw_E200_fs_2_v5_int8_vela_model_flash.bin`
...
3. From `<sdk-root>/examples`, build the example:
   ...
   make cm55_inference_basic_flash_sample_app_defconfig BOARD=SR110_RDK BUILD=SRSDK
   ```
