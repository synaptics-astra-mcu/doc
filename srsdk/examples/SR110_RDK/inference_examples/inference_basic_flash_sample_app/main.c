...
/**
 * \brief Initialize and log system tick information
 */
int main(void)
{
    ...
    /* Start Inference basic flash sample app. */
    /* Create task from which the inference will be triggered */
    BaseType_t task_status = xTaskCreate (single_model_flash_sample_app,
                                            "model_flash",
                                            512,
                                            NULL,
                                            tskIDLE_PRIORITY+1,
    ...
    {
        LOG_ERROR(LOG_MOD_INFERENCE, "Error creating single model task !!!!!!\n");
    }
