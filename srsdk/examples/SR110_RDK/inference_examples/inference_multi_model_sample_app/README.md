...
1. From `<sdk-root>/examples`, build the example:
   ...
   make cm55_inference_multi_model_sample_app_defconfig BOARD=SR110_RDK BUILD=SRSDK
   ```
2. Rebuild the application using pre-built package:
   ```bash
   make cm55_inference_multi_model_sample_app_defconfig BOARD=SR110_RDK or make
   ```
