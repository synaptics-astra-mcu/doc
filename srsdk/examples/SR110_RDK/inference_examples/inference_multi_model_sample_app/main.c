...
int main(void)
{
    ...
    /* Start Inference multi model sample app. */
    /* Create task from which the inference will be triggered */
    BaseType_t task_status = xTaskCreate (multi_model_sample_app,
                                            "multi_model",
                                            512,
                                            NULL,
                                            tskIDLE_PRIORITY+1,
    ...
    {
            LOG_ERROR(LOG_MOD_INFERENCE, "Error creating multi model task !!!!!!\n");
    }
