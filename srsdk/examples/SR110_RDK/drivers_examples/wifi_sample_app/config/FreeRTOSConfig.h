...
//  #include "RTE_Components.h"
 ...
 //  <i> Default: 16
 #define configMAX_SYSCALL_INTERRUPT_PRIORITY     159  /* equivalent to priority 4. */
 ...
 #define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()system_get_utick()
 #define portGET_RUN_TIME_COUNTER_VALUE()        system_get_utick()
